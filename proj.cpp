...
struct trains
{
    string TName, TID, TDest, TSource, TDate, arriveTime, departTime, TClasses, TxtFName;
    int TSeats;
};
struct SeatRecord
{
...
void admin();
int main();
string Name, Age, NIC, Contact, Dest, Source, SeatNum, Class, TID, Date, ATime, DTime,
    TName;
...
login:
    ...
    // cin >> password;
    if (user == "Shalal" && password == "shalal123" || user == "Arham" && password == "arham123" || user == "Mania" && password == "mania123")
    {
